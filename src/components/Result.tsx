...
const Result = () => {
  ...
  const [computerChoiceImage, setComputerChoiceImage] = useState(
    require("../assets/question.png").default
  );
  const [customerChoiceImage, setCustomerChoiceImage] = useState(
    require("../assets/question.png").default
  );
  ...
  const getResult = async () => {
    setCustomerChoiceImage(
      require("../assets/" +
        gameOptions.find((it) => it.name === gamesState.game.customerChoice)
          ?.image).default
    );
    ...
    setComputerChoiceImage(
      require("../assets/" +
        gameOptions.find((it) => it.name === resultBody.computerChoice)?.image)
        .default
    );
    setLoading(false);
  };
  ...
  return (
    <div className="result-container">
      <a className="play-again-button" href="/">
        play again
      </a>
      <div className="results">
        <div className="results_item">
          <div>Your choice</div>
          <img
            alt={gamesState.game.customerChoice}
            src={customerChoiceImage}
